/**
 * ArduiBeeScale - ATtiny85 Power Management Controller
 *
 * Runs on ATtiny85 microcontroller. Provides:
 * - Ultra-low power sleep/wake cycles
 * - Watchdog timer-based wake scheduling
 * - MOSFET control for Arduino power management
 * - Maximum operation timeout protection
 *
 ...
 * License: GNU GPLv3
 *
 * Hardware: ATtiny85-20PU
 * Pins:
 *  - PIN 0: MOSFET gate output (power control)
 *  - PIN 1: Arduino completion signal input
 */
